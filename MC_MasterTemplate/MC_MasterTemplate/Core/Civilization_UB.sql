...
VALUES 	('TRAIT_SORTIENT_GOLD_LUXURY_RESOURCES_INTERNATIONAL', 'YieldType', 'ARGTYPE_IDENTITY', 'YIELD_GOLD'),
		('TRAIT_SORTIENT_GOLD_LUXURY_RESOURCES_INTERNATIONAL', 'Amount', 'ARGTYPE_IDENTITY', 0.5),
		('TRAIT_SORTIENT_PRODUCTION_LUXURY_RESOURCES_INTERNATIONAL', 'YieldType', 'ARGTYPE_IDENTITY', 'YIELD_PRODUCTION'),
		('TRAIT_SORTIENT_PRODUCTION_LUXURY_RESOURCES_INTERNATIONAL', 'Amount', 'ARGTYPE_IDENTITY', 0.5);
