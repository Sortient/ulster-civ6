...
VALUES	('COLOR_SORTIENT_ULSTER_A_PRIMARY',		'255,255,255,255'		),
		...
		('COLOR_SORTIENT_ULSTER_C_PRIMARY',		'255,199,44,255'	),
		('COLOR_SORTIENT_ULSTER_C_SECONDARY',		'218,41,28,255'		),
		('COLOR_SORTIENT_ULSTER_D_PRIMARY',		'255,255,255,255'		),
		('COLOR_SORTIENT_ULSTER_D_SECONDARY',		'0,80,82,255'	),
		('COLOR_SORTIENT_ULSTER_E_PRIMARY',		'255,255,255,255'		),
		('COLOR_SORTIENT_ULSTER_E_SECONDARY',		'0,80,82,255'	),
		('COLOR_SORTIENT_ULSTER_F_PRIMARY',		'1,33,105,255'		),
		('COLOR_SORTIENT_ULSTER_F_SECONDARY',		'200,16,46,255'	);
