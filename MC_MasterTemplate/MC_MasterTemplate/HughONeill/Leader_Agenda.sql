...
INSERT INTO Types
			(Type,							Kind			)
VALUES		('TRAIT_AGENDA_SORTIENT_HUGH_ONEILL',		'KIND_TRAIT'	);
...
VALUES 		('AGENDA_SORTIENT_HUGH_ONEILL',	'LOC_AGENDA_SORTIENT_HUGH_ONEILL_NAME',	'LOC_AGENDA_SORTIENT_HUGH_ONEILL_DESCRIPTION'		);
...
VALUES		('TRAIT_AGENDA_SORTIENT_HUGH_ONEILL',		'LOC_AGENDA_SORTIENT_HUGH_ONEILL_NAME',	'LOC_AGENDA_SORTIENT_HUGH_ONEILL_DESCRIPTION'		);
...
VALUES 		('AGENDA_SORTIENT_HUGH_ONEILL',	'TRAIT_AGENDA_SORTIENT_HUGH_ONEILL'	);
...
VALUES 		('LEADER_SORTIENT_HUGH_ONEILL',	'AGENDA_SORTIENT_HUGH_ONEILL'		);
...
INSERT INTO ExclusiveAgendas
			(AgendaOne,				AgendaTwo					)
VALUES 		('AGENDA_SORTIENT_HUGH_ONEILL',	'AGENDA_INDUSTRIALIST'		);
...
VALUES		('TRAIT_AGENDA_SORTIENT_HUGH_ONEILL',		'AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY'	),
			('TRAIT_AGENDA_SORTIENT_HUGH_ONEILL',		'AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY'		);
...
VALUES		('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',	'REQSET_SORTIENT_HUGH_ONEILL_UNHAPPY'		),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',		'MODIFIER_PLAYER_DIPLOMACY_SIMPLE_MODIFIER',	'REQSET_SORTIENT_HUGH_ONEILL_HAPPY'		);
...
VALUES		('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',		'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',		'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	);
...
VALUES		('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',	'InitialValue',					-5													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',	'IncrementValue',				-1													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',	'IncrementTurns',				-10													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',	'MaxValue',						-25													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',	'StatementKey',					'LOC_DIPLO_WARNING_LEADER_SORTIENT_HUGH_ONEILL_REASON_ANY'	),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY',	'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_SORTIENT_HUGH_ONEILL_UNHAPPY'				),
	
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',	'InitialValue',					5													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',	'IncrementValue',				1													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',	'IncrementTurns',				10													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',	'MaxValue',						12													),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',	'StatementKey',					'LOC_DIPLO_KUDO_LEADER_SORTIENT_HUGH_ONEILL_REASON_ANY'		),
			('AGENDA_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY',	'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_SORTIENT_HUGH_ONEILL_HAPPY'				);
...
VALUES		('REQSET_SORTIENT_HUGH_ONEILL_UNHAPPY',	'REQUIREMENTSET_TEST_ALL'	),
			('REQSET_SORTIENT_HUGH_ONEILL_HAPPY',		'REQUIREMENTSET_TEST_ALL'	);
...
VALUES		('REQSET_SORTIENT_HUGH_ONEILL_UNHAPPY',	'REQUIRES_MAJOR_CIV_OPPONENT'		),
			('REQSET_SORTIENT_HUGH_ONEILL_UNHAPPY',	'REQUIRES_MET_10_TURNS_AGO'			),
			('REQSET_SORTIENT_HUGH_ONEILL_UNHAPPY',	'REQUIRES_HAS_LOW_FAITH'			),
			('REQSET_SORTIENT_HUGH_ONEILL_HAPPY',		'REQUIRES_MAJOR_CIV_OPPONENT'		),
			('REQSET_SORTIENT_HUGH_ONEILL_HAPPY',		'REQUIRES_MET_10_TURNS_AGO'			),
			('REQSET_SORTIENT_HUGH_ONEILL_HAPPY',		'REQUIRES_HAS_HIGH_CULTURE'			),
			('REQSET_SORTIENT_HUGH_ONEILL_HAPPY',		'REQUIRES_HAS_HIGH_SCIENCE'			);
